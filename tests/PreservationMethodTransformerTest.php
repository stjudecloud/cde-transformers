...
{
    public function test_minus_20_degrees_transform()
    {
    ...
    public function test_minus_80_degrees_transform()
    {
    ...
    public function test_cryopreserved_transform()
    {
    ...
    public function test_cytospin_slide_transform()
    {
    ...
    public function test_edta_transform()
    {
    ...
    public function test_ffpe_transform()
    {
    ...
    public function test_formalin_fixed_buffered_transform()
    {
    ...
    public function test_formalin_fixed_unbuffered_transform()
    {
    ...
    public function test_formalin_fixed_tissue_transform()
    {
    ...
    public function test_fresh_transform()
    {
    ...
    public function test_fresh_dissociated_transform()
    {
    ...
    public function test_fresh_dissociated_single_cell_sorted_transform()
    {
    ...
    public function test_fresh_dissociated_single_cell_sorted_plates_transform()
    {
    ...
    public function test_frozen_transform()
    {
    ...
    public function test_isopentane_transform()
    {
    ...
    public function test_liquid_nitrogen_transform()
    {
    ...
    public function test_not_applicable_transform()
    {
    ...
    public function test_rnalater_transform()
    {
    ...
    public function test_snap_frozen_transform()
    {
    ...
    public function test_trizol_transform()
    {
    ...
    public function test_unknown_transform()
    {
